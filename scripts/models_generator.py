#-*- coding: utf-8 -*-
"""Generate the definition of models that meet the requirements of Flask-SqlAlchemy based on
existing tables are based on the database that uses SQLAutocode"""
